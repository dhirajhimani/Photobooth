...
//    static final float[] DIMENSIONS_LANDSCAPE = {460, 260};	// ORIGINAL
//    static final float[] DIMENSIONS_PORTRAIT = {280, 420};	// ORIGINAL
	static final float[] DIMENSIONS_LANDSCAPE = {480, 320};
    static final float[] DIMENSIONS_PORTRAIT = {320, 480};
...
//        addContentView(mContent, FILL);
    ...
    private void setUpTitle() {
        ...
        Drawable icon = getContext().getResources().getDrawable(R.drawable.twitter_btn_normal);
